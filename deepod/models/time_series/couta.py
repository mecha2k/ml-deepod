...
class COUTA(BaseDeepAD):
    ...
    Args:
        ...
        epochs (int, optional): 
            The total number of complete passes through the entire training datasets. More epochs can potentially
        ...
        epoch_steps (int, optional): 
            Defines the number of mini-batch updates within each epoch. Setting this to -1 uses the full datasets
    ...
    def decision_function(self, X, return_rep=False):
        ...
        Args:
            ...
            X (numpy.ndarray): 
                The input datasets to compute anomaly scores for. numpy array of shape (n_samples, n_features)
    ...
    def _training_ray(self, config, X_test, y_test):
        ...
        Args:
            ...
            X_test (numpy.ndarray, optional): 
                Test datasets features for evaluation during training. Default is None.
                
            y_test (numpy.ndarray, optional): 
                Test datasets labels for evaluation during training. Default is None.
...
class _SubseqData(Dataset):
    """
    This class is used to create a datasets object for PyTorch's DataLoader. It takes in sequences, labels, and two sets of sample weights.
    ...
    The class provides methods to get the length of the datasets and to get a data point by its index.
