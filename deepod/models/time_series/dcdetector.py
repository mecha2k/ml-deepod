...
class DCdetector(BaseDeepAD):
    ...
    Args:
        ...
        epochs (int, optional):
            The number of epochs. This parameter determines the number of times the model will iterate over the entire datasets during training. Default is 5.
    ...
    def fit(self, X, y=None):
        ...
        and iterating over the datasets for a specified number of epochs to train the model.
    ...
    def training(self, dataloader):
        """
        Train the model for one epoch using the provided DataLoader. It iterates over the datasets, calculates losses for each batch,
