...
class TcnED(BaseDeepAD):
    ...
    Args:
        ...
        epoch_steps (int): 
            The number of steps per epoch. Default is -1, indicating use of the full datasets.
    ...
    def inference_prepare(self, X):
        ...
        Returns:
            ...
            DataLoader: 
                A data loader containing the test datasets.
    ...
    def _training_ray(self, config, X_test, y_test):
        ...
        Args:
            ...
            X_test (numpy.ndarray): 
                The test datasets features.
            
            y_test (numpy.ndarray):
                The test datasets labels.
